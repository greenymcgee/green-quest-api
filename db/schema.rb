...
ActiveRecord::Schema[7.2].define(version: 2024_11_24_215017) do
  ...
  create_table "artworks_games", force: :cascade do |t|
    t.bigint "artwork_id"
    t.bigint "game_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artwork_id"], name: "index_artworks_games_on_artwork_id"
    t.index ["game_id"], name: "index_artworks_games_on_game_id"
  end
